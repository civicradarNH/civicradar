...
- `ERR-NGO/Admin` **Suite NGO/Admin crashed** — ElementHandle.click: Timeout 30000ms exceeded.
Call log:
  - attempting click action
  -     - waiting for element to be
- `U16` **Persona bar hidden during home-hero; ward context after dismiss** — failed
- `RP12b` **Camera cancel + Map tap keeps report open at capture** — failed
- `VOL04` **Hours picker present** — failed
...
| C09c | Citizen | Empty display name gets unique civic default | PASS | name=Drain Detective #527A |
...
| C16 | Citizen | Report submit success modal | PASS | rid=3e3780b3-ceed-42d4-a115-b3bf4ff0d077 |
...
| ERR-NGO/Admin | System | Suite NGO/Admin crashed | **FAIL** | ElementHandle.click: Timeout 30000ms exceeded.
Call log:
  - attempting click action
  -     - waiting for element to be |
...
| U16 | UI | Persona bar hidden during home-hero; ward context after dismiss | **FAIL** |  |
| U17 | UI | Partner inquiry exported | PASS |  |
| U18 | UI | PWA nudge dismiss button | PASS |  |
| U19 | UI | PWA nudge dismiss hides | PASS |  |
| U29 | UI | Toast has dismiss × control | PASS |  |
...
| RP12b | Report | Camera cancel + Map tap keeps report open at capture | **FAIL** |  |
...
| VOL04 | Volunteer | Hours picker present | **FAIL** |  |
| VOL05 | Volunteer | Profile links to Resources (no inline signup) | PASS |  |
...
| CL03 | Celebration | Official filing accordion present | PASS |  |
...
| TR03 | Tour | Purpose sheet shows on first run (no FAB tip stack) | PASS |  |
...
| TR10 | Tour | Purpose sheet blocks pin popup open | PASS |  |
...
| OC06 | OfficialChannels | Resources subtitle + Recommended badges + Help cards | PASS |  |
