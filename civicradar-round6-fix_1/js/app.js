...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function setButtonLoading(btn, loading, loadingLabel) {
    ...
    // Clearing the submit button's loading state ends a submission attempt.
  ...
  async function submitReport() {
    ...
    // Re-entrancy lock: a rapid double-tap must not double-file during the

    // async geolocation window. Released on early returns + setButtonLoading(false).
